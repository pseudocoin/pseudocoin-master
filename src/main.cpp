...
int64 nChainStartTime = 1404467145;
...
const string strMessageMagic = "Pseudocoin Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Pseudocoin
    bool fStrictPayToScriptHash = true; // Always active in Pseudocoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Pseudocoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "14044140446714566043";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0xe1bbace5eb425ce9b1621f92d94ec171d42092a24d2bc84f9565cce95efd1cea"));
